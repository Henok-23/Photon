...
## Download Photon
Go to [photondesktop.com](https://photondesktop.com) to download and try it.  
No need to package anything yourself!

I can only give access to the first 100 users because I haven't gotten approval from Google API access yet, and they limit users only for 100 users until they give approval. You can still register even if it hits the limit — you will be notified as soon as I get full API access.
...
3. Create your own Google API (include Gmail API and People API) and an OpenAI API key.  
...
into GPT or Claude and you will be able to resolve it.
